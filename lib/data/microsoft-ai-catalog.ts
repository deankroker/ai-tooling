...
export const azureAIProducts: MicrosoftAIProduct[] = [
  {
    id: 'microsoft-foundry-portal',
    name: 'Microsoft Foundry Portal',
    category: 'Azure',
  ...
  {
    id: 'microsoft-foundry-sdk',
    name: 'Microsoft Foundry SDK',
    category: 'Azure',
    subcategory: 'Core Platform',
    status: 'GA',
    gaCapabilities: [
    ...
    integrations: ['microsoft-foundry-portal'],
  ...
  },
  {
    ...
    integrations: ['microsoft-foundry-portal', 'microsoft-defender'],
  ...
  },
  {
    ...
    integrations: ['microsoft-foundry-portal', 'semantic-kernel'],
  ...
  // Azure OpenAI
  {
    ...
    integrations: ['microsoft-foundry-portal', 'azure-ai-search'],
    relatedProducts: ['github-models'],
  ...
  // Azure AI Search
  {
    ...
    integrations: ['azure-openai', 'microsoft-foundry-portal'],
  ...
  // Cognitive Services
  {
    ...
    integrations: ['microsoft-foundry-portal', 'copilot-studio'],
  ...
  },
  {
    ...
    integrations: ['microsoft-foundry-portal', 'ai-builder'],
...
export const agenticProducts: MicrosoftAIProduct[] = [
  ...
  },
  {
    ...
    gaCapabilities: [],
    previewFeatures: [
      'AI-powered root cause analysis (minutes vs hours)',
      'Continuous Azure resource monitoring',
      'Anomaly detection and alerting',
      'Automated incident triage and mitigation',
      'Natural language commands',
      'Reduces Mean Time to Recovery (MTTR)',
    ],
    brandPositioning: 'AI-powered site reliability engineering',
    surfaces: ['Azure Portal', 'Azure Monitor', 'ServiceNow', 'PagerDuty'],
    targetAudience: ['ITAdmins', 'Developers'],
    pricingModel: {
      type: 'PayAsYouGo',
      price: '4 AAU/hour + 0.25 AAU/second',
      unit: 'Azure Agent Units',
      notes: 'Always-on monitoring + active incident mitigation'
    },
    integrations: ['azure-monitor', 'servicenow', 'pagerduty', 'azure-devops', 'github', 'dynatrace'],
    relatedProducts: ['copilot-azure'],
    documentation: 'https://learn.microsoft.com/en-us/azure/sre-agent/overview',
    lastUpdated: '2026-02-05',
  },
  {
    id: 'copilot-azure',
...
export const windowsProducts: MicrosoftAIProduct[] = [
  ...
  },
  {
    ...
    relatedProducts: ['microsoft-foundry-portal'],
    lastUpdated: '2026-02-05',
  },
];
...
export const keyDates: KeyDate[] = [
  { date: 'Nov 2024', event: 'Azure AI Studio → Microsoft Foundry rebrand', category: 'Azure' },
  { date: 'Nov 2025', event: 'Microsoft Foundry → Microsoft Foundry rebrand', category: 'Azure' },
  ...
  { date: 'Sept 2025', event: 'Azure SRE Agent billing begins (Build 2025 announcement)', category: 'Azure' },
